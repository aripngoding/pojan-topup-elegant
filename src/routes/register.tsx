      ...
      <main className="mx-auto flex max-w-md flex-col items-center px-4 py-12">
        <div className="w-full rounded-3xl border border-border bg-card p-8 shadow-card">
          <div className="mb-6 flex flex-col items-center gap-2">
            ...
            <h1 className="font-display text-xl font-bold text-foreground">Buat Akun Baru</h1>
            <p className="text-sm text-muted-foreground">Daftar gratis, top up langsung!</p>
          </div>
